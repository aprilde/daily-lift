...
daily-lift/
├── README.md
├── CLAUDE.md                                   # Instructions for Claude Code when working on the app
...
Prototype complete and tested. Team review complete, with the hardened plan and decision log recorded. Native build complete and installable.
