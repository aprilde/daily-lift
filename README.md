...
Try the prototype
prototype/prototype.html is a fully working, self-contained prototype — open it in any browser (desktop or mobile):
...
Phase 1 — the app. All viewing, editing, form tips, and local storage. See build/claude-code-prompt-phase1-app.md.
...
├── README.md
├── prototype/
│   ├── workout-widget-prototype.html       ← your renamed file
│   └── claude-code-prompt-phase1-app.md    ← the prompt lives here now
├── build/                                  ← empty for now; real app work goes here later
└── images/
    └── prototype-demo.gif
Status
